            ...
            >
                ...
                <View style={styles.card}>
                    ...
                    <ProfileItem icon="person" label="معلومات الحساب" onPress={() => {
                        router.push('/(routes)/market/home/account/AccountInfo');
                    }} />
                    <ProfileItem icon="settings-outline" label="الاعدادات العامة" onPress={() => {
                        router.push('/(routes)/market/home/account/GeneralSettings')
                    }} />
                </View>
                ...
                <View style={styles.card}>
                    ...
                    <ProfileItem icon="ticket-outline" label="الكوبنات" onPress={() => {
                        router.push('/(routes)/market/home/account/Copuns');
                    }} />

                    <ProfileItem icon="id-card" label="الباقات" onPress={() => {
                        router.push('/(routes)/market/home/account/plans');
                    }} />
                </View>
                ...
                <View style={styles.card}>
                    ...
                    <ProfileItem icon="help-circle-outline" label="الدعم الفني" onPress={() => {
                        router.push('/(routes)/market/home/account/HelpCenter');
                    }} />
                </View>
