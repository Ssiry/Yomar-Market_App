...
const Login = () => {
    ...
    return (
        <SafeAreaView style={styles.safeContainer}>
            ...
            <TouchableOpacity
                onPress={() => { router.push('/(routes)/delivery/auth/checkPhone') }}
            ...
            <Text style={[styles.separatorText, { marginTop: scale(12), textAlign: 'center', width: '70%', fontSize: scale(14), color: '#a4a4a4', fontWeight: '500' }]}>
                يمكنك التسجيل من خلال التواصل مع المتجر مباشرة
            </Text>


            {/* <TouchableOpacity
                onPress={() => router.push("/(routes)/delivery/auth/register")}
