...
export const OnBoardingData: OnBoardingDataType[] = [

    {
        ...
        subtitle: "اطلب اللي تبيه من أقرب محل، وحنّا نوصلّه لك لباب بيتك بسرعة.",
        image: <OnBoarding1 />
    },
    {
        id: "2",
        title: "تصفح المحلات واطلبها بلمسة",
        subtitle: "شوف المنتجات حولك، اطلبها بسهولة، وتابع الطلب خطوة بخطوة.",
        image: <OnBoarding2 />
    },
    {
        id: "3",
