    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                <TouchableOpacity style={styles.lastCard}>
                    <Text style={{ fontFamily: "Almarai", fontSize: scale(12), fontWeight: '600', textAlign: 'center', color: '#036E65' }}>
                        كل
                        {'\n'}
                        المحلات
...
const styles = StyleSheet.create({
    container: {
        marginTop: scale(12), height: scale(205), backgroundColor: "transparent", borderRadius: scale(8)
    },
    card: {
        backgroundColor: "white", width: scale(220), height: scale(205), marginRight: scale(12), borderRadius: scale(13), padding: scale(8), boxShadow: 'black', borderColor: '#E5E5E5', borderWidth: scale(1), display: 'flex', gap: scale(8)
    },
    bottomCard: {
